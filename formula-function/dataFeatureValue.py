...
def prescriptionFeature():
    ...
    medicaldata = data_process.read_csv(readcsvname)

    # readcsvname = 'allData_normal1.csv'
    readcsvname = 'allData1.csv'
    prescriptiondata = data_process.read_csv(readcsvname)

    readcsvname = 'allLabelDataValue.csv'
    labeldata = data_process.read_csv(readcsvname)
    ...
    # data_process.write_in_csv(writecsvname , presFeatrue)
    #
    # writecsvname = 'labelFeature2.csv'
    # data_process.write_in_csv(writecsvname , presLabelFeatrue)
